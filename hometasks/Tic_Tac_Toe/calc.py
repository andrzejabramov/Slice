...
#
# dig1 = Entry(root, width=10)
# dig1.grid(column=0, row=0)
#
# add = Label(root, text="+")
# add.grid(column=1, row=0, sticky=NW)
#
# dig2 = Entry(root, width=10)
# dig2.grid(column=3, row=0)
#
# add1 = Label(root, text="=")
# add1.grid(column=4, row=0, sticky=W)
#
# res = Label(root, text="    ", bd=1, relief='solid')
# res.grid(column=4, row=0, padx=20, sticky=E)

#label = tk.Label(root, text="Label with Border", bd=10, relief="solid") label.pack()
